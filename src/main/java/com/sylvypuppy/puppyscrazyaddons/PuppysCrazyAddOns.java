...
@Mod(PuppysCrazyAddOns.MODID)
public class PuppysCrazyAddOns {
    public static final String MODID = "puppyscrazyaddons";
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if(event.getTabKey() == CreativeModeTabs.COMBAT){
            event.accept(ModItems.Puppore_Sword);
        }
        ...
        if(event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES){
            ...
            event.accept(ModItems.Puppore_Pickaxe);
    ...
    @EventBusSubscriber(modid = PuppysCrazyAddOns.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
